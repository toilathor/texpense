...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "createAccountDes": MessageLookupByLibrary.simpleMessage(
            "Hãy bắt đầu bằng cách tạo tài khoản để bảo mật dữ liệu của bạn và quản lý trên nhiều thiết bị bất kỳ lúc nào!"),
        "signUpGoogle":
